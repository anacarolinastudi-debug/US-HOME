-- Gera instâncias de recorrentes para o mês atual + 2 meses à frente (era 1).
    ...
    loop
      ...
      values (
        ...
        make_date(
          ...
          least(coalesce(v_template.recurrence_day, 1),
            extract(day from (date_trunc('month', v_target_date) + interval '1 month - 1 day'))::int)
        ),
        v_template.id,
        v_target_month,
